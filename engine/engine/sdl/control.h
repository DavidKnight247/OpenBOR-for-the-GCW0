...
#include "joysticks.h"
	...
	#define	CONTROL_DEFAULT1_FIRE1		SDL_SCANCODE_LCTRL
	#define	CONTROL_DEFAULT1_FIRE2		SDL_SCANCODE_SPACE
	#define	CONTROL_DEFAULT1_FIRE3		SDL_SCANCODE_BACKSPACE
	#define	CONTROL_DEFAULT1_FIRE4		SDL_SCANCODE_TAB
	#define	CONTROL_DEFAULT1_FIRE5		SDL_SCANCODE_LALT
	#define	CONTROL_DEFAULT1_FIRE6		SDL_SCANCODE_LSHIFT
